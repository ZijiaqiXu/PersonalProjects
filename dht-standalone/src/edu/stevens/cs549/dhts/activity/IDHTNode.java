...
public interface IDHTNode {
	 ...
	 */
	public String[] getNet(String k) throws Failed, Invalid;
	
	public void addNet(String k, String v) throws Failed, Invalid;
	
	public void deleteNet(String k, String v) throws Failed, Invalid;
