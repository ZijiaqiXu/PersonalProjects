...
public class NodeResource {
	...
	@GET
	@Produces("application/xml")
	public Response getBinding(@QueryParam("key") String k) {
		return new NodeService(headers, uriInfo).getBinding(k);
	}

	@PUT
	public Response putBinding(@QueryParam("key") String k,@QueryParam("val") String v) {
		return new NodeService(headers, uriInfo).addBinding(k, v);
		// NodeInfo p = predDb.getInfo();
	}
	
	@DELETE
	public Response deleteBinding(@QueryParam("key") String k,@QueryParam("val") String v) {
		return new NodeService(headers, uriInfo).deleteBinding(k, v);
	}
	...
	// SSE methods returns output stream
	@GET
	@Path("listen")
	@Produces(SseFeature.SERVER_SENT_EVENTS)
	public Response getOutputStream(@QueryParam("id") String index, @QueryParam("key") String key) {
		int id = Integer.parseInt(index);
	...
	@DELETE
	@Path("listen")
	public Response stopListening(@QueryParam("id") String index, @QueryParam("key") String key) {
		int id = Integer.parseInt(index);
